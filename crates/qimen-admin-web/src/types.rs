...
pub struct GeneralConfigView {
    ...
    pub marketplace_catalog_url: String,
    pub marketplace_cache_dir: String,
    pub marketplace_lock_path: String,
    pub marketplace_request_timeout_secs: u64,
    pub marketplace_allow_prerelease: bool,
...
pub fn general_view(config: &AppConfig) -> GeneralConfigView {
    GeneralConfigView {
        ...
        marketplace_catalog_url: config.marketplace.catalog_url.clone(),
        marketplace_cache_dir: config.marketplace.cache_dir.clone(),
        marketplace_lock_path: config.marketplace.lock_path.clone(),
        marketplace_request_timeout_secs: config.marketplace.request_timeout_secs,
        marketplace_allow_prerelease: config.marketplace.allow_prerelease,
        marketplace_auto_update: config.marketplace.auto_update,
