...
export function generalToMutation(
  ...
  return {
    ...
    command_help_enabled: general.command_help_enabled,
    command_help_page_size: general.command_help_page_size,
    command_plugins_enabled: general.command_plugins_enabled,
    command_registry_enabled: general.command_registry_enabled,
