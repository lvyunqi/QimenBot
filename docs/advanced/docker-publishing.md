...
```bash
docker buildx imagetools inspect mryunqi/qimenbot:0.1.20
docker pull mryunqi/qimenbot:0.1.20
docker image inspect mryunqi/qimenbot:0.1.20 --format '{{.Architecture}} {{.Os}}'
```
