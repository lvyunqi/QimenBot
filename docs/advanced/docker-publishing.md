...
```bash
docker buildx imagetools inspect mryunqi/qimenbot:0.1.17
docker pull mryunqi/qimenbot:0.1.17
docker image inspect mryunqi/qimenbot:0.1.17 --format '{{.Architecture}} {{.Os}}'
```
