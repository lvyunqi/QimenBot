...
```bash
docker buildx imagetools inspect mryunqi/qimenbot:0.1.16
docker pull mryunqi/qimenbot:0.1.16
docker image inspect mryunqi/qimenbot:0.1.16 --format '{{.Architecture}} {{.Os}}'
```
