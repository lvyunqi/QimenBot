...
```bash
docker buildx imagetools inspect mryunqi/qimenbot:0.1.21
docker pull mryunqi/qimenbot:0.1.21
docker image inspect mryunqi/qimenbot:0.1.21 --format '{{.Architecture}} {{.Os}}'
```
